...
class TSrvIfaceMgr : public TIfaceMgr {
  public:
    ...
    SPtr<TSrvMsg> decodeMsg(int ifindex, SPtr<TIPv6Addr> peer, char * buf, int bufsize);

    SPtr<TSrvMsg> decodeRelayForw(SPtr<TIfaceIface> physicalIface, SPtr<TIPv6Addr> peer, char * buf, int bufsize);
