...
class TRelIfaceMgr : public TIfaceMgr {
  public:
    ...
    SPtr<TRelMsg> decodeMsg(SPtr<TIfaceIface> iface, SPtr<TIPv6Addr> peer, char * buf, int bufsize);

    SPtr<TRelMsg> decodeRelayRepl(SPtr<TIfaceIface> iface, SPtr<TIPv6Addr> peer, char * buf, int bufsize);
    SPtr<TRelMsg> decodeRelayForw(SPtr<TIfaceIface> iface, SPtr<TIPv6Addr> peer, char * buf, int bufsize);
    SPtr<TRelMsg> decodeGeneric(SPtr<TIfaceIface> iface, SPtr<TIPv6Addr> peer, char * buf, int bufsize);
    void dump();
