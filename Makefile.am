...
# Uncomment this if you don't want makefiles to rebuild themselves
# Makefile:

SUBDIRS  = Misc Options AddrMgr CfgMgr ClntAddrMgr ClntCfgMgr ClntIfaceMgr ClntMessages
SUBDIRS += ClntOptions ClntTransMgr IfaceMgr Messages
