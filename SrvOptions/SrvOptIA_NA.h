...
public:
  TSrvOptIA_NA(SPtr<TSrvOptIA_NA> queryOpt, SPtr<TIPv6Addr> clntAddr,
               SPtr<TDUID> duid, int iface, unsigned long &addrCount,
               int msgType, TMsg *parent);
  TSrvOptIA_NA(char *buf, int bufsize, TMsg *parent);
  TSrvOptIA_NA(long IAID, long T1, long T2, TMsg *parent);
  TSrvOptIA_NA(long IAID, long T1, long T2, int Code, const std::string &Msg,
               TMsg *parent);
  TSrvOptIA_NA(SPtr<TSrvOptIA_NA> queryOpt, SPtr<TSrvMsg> queryMsg,
               TMsg *parent);
...
private:
  ...
  bool assignRequestedAddr(SPtr<TSrvMsg> queryMsg, SPtr<TSrvOptIA_NA> queryOpt,
                           bool quiet);
  ...
  bool assignAddr(SPtr<TIPv6Addr> addr, uint32_t pref, uint32_t valid,
                  bool quiet);
