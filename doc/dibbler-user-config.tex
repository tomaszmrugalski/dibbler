%%
%% $Id: dibbler-user-config.tex,v 1.20 2006-07-04 00:20:32 thomson Exp $
%%
...
for FQDN will get this name. In following example, name 'zebuline' is
reserved for address 2000::1, kael is reserved for 2000::2 and
test.example.com is reserved for client using DUID
00:01:00:00:43:ce:25:b4:00:13:d4:02:4b:f5. 

Also note that is possible to define, which side can perform updates.
...
client. When this value is set to 0, server will not perform any updates.
...
%% Revision 1.19  2006-07-01 12:46:09  thomson
%% Docs updates, precise log-mode added, TA, FQDN options described.
%%
%% Revision 1.18  2005/10/23 23:33:03  thomson
%% *** empty log message ***
%%
%% Revision 1.17  2005/08/07 17:54:52  thomson
%% Minor changes related to 0.4.1 release.
%%
%% Revision 1.16  2005/08/02 23:43:27  thomson
%% *** empty log message ***
%%
%% Revision 1.15  2005/07/21 23:28:56  thomson
%% Documentation update.
%%
%% Revision 1.14  2005/03/15 23:02:31  thomson
%% 0.4.0 release.
%%
%% Revision 1.13  2005/03/07 22:45:51  thomson
%% Typo fix.
%%
%% Revision 1.12  2005/02/01 23:06:48  thomson
%% *** empty log message ***
%%
%% Revision 1.11  2005/01/23 23:16:56  thomson
%% Relay related things.
%%
%% Revision 1.10  2004/12/01 20:55:49  thomson
