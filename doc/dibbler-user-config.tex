%%
%% $Id: dibbler-user-config.tex,v 1.14 2005-03-15 23:02:31 thomson Exp $
%%
...
%   log-level, prefered-lifetime, valid-lifetime, t1, t2,
...
%   accept-only, reject-only, t1, t2, prefered-lifetime,
