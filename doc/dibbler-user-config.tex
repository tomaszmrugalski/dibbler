%%
%% $Id: dibbler-user-config.tex,v 1.16 2005-08-02 23:43:27 thomson Exp $
%%
...
details, so keep those log very short. Config file looks like that:
...
\subsubsection{Example 7: Relay support}
...
\subsubsection{Example 8: 2 relays}
