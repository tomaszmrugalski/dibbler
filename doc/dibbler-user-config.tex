...
%%
%% $Id: dibbler-user-config.tex,v 1.29 2006-09-12 22:57:19 thomson Exp $
%%
...
\begin{description}
 ...
 \item[ntp-server] -- (scope: interface, type: address list, default:
	    ...
	    servers. Network Time Protocol \cite{ntp} is a protocol used
 ...
 \item[time-zone] -- (scope: interface, type: timezone, default:
	    ...
	    \cite{timezone-draft}. Work on this draft seems to be
...
they will be used as a default values. Config file has following syntax:
...
\begin{description}
 ...
 \item[cache-size] -- (scope: global, type: integer, default:
	    1048576). It defines a size of the memory which can se used
	    to store cached entries.
 ...
 \item[rapid-commit] -- (scope: interface, type: boolean, default: 0). 
