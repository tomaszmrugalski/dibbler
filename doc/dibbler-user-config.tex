...
%%
%% $Id: dibbler-user-config.tex,v 1.54 2008-06-25 23:19:47 thomson Exp $
%%
...
\subsubsection{Example 15: Confirm}
\label{example-client-confirm}
It is possible to configure client to send \msg{CONFIRM} message, when
there is an old lease addresses database. Please note that this
feature have been developed very lately.
