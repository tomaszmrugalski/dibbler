...
To install Dibbler on Debian or other system with apt-get management
system, run $apt-get install package$ command. For example, to install
server and client, issue the following command:
...
Note that configure script was added in 0.8.1RC1. Earlier sources do
not need that step.
