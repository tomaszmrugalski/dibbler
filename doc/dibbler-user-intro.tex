...
%%
%% $Id: dibbler-user-intro.tex,v 1.15 2006-10-01 22:37:33 thomson Exp $
%%
...
\begin{itemize}
 \item Prefix Delegation \cite{rfc3633}
 \item Authorization \cite{rfc3315}
 \item Reconfigure mechanism \cite{rfc3315}
 \item DNSSec (DNS Security Extensions) \cite{rfc4033} in DNS Updates \cite{draft-fqdn}
\end{itemize}
...
%% Revision 1.14  2006-09-03 09:49:08  thomson
%% *** empty log message ***
%%
%% Revision 1.13  2006-08-30 01:43:55  thomson
%% *** empty log message ***
%%
