%%
%% $Id: dibbler-user-intro.tex,v 1.4 2004-10-25 20:45:54 thomson Exp $
%%
...
client. Currently there are ports available for Windows XP and 2003
...
\item Power failure/crash support (CONFIRM and REPLY messages) -- after
  ...
  \footnote{As for 0.2.1 version, this functionality works on server side only,
  client side support will be available in 0.2.2.}.
