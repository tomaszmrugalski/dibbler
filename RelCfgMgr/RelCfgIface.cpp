...
int TRelCfgIface::getID() { return ID_; }

string TRelCfgIface::getName() { return Name_; }
...
SPtr<TIPv6Addr> TRelCfgIface::getServerUnicast() { return ServerUnicast_; }

SPtr<TIPv6Addr> TRelCfgIface::getClientUnicast() { return ClientUnicast_; }

bool TRelCfgIface::getClientMulticast() { return ClientMulticast_; }

bool TRelCfgIface::getServerMulticast() { return ServerMulticast_; }
...
void TRelCfgIface::setName(std::string ifaceName) { Name_ = ifaceName; }

void TRelCfgIface::setID(int ifaceID) { ID_ = ifaceID; }

int TRelCfgIface::getInterfaceID() { return InterfaceID_; }
