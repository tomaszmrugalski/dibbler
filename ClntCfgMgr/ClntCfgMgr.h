...
private:
  ...
  bool validateAddr(SPtr<TClntCfgIface> ptrIface, SPtr<TClntCfgIA> ptrIA,
                    SPtr<TClntCfgAddr> ptrAddr);
  bool validatePD(SPtr<TClntCfgIface> ptrIface, SPtr<TClntCfgPD> ptrPD);
  bool validatePrefix(SPtr<TClntCfgIface> ptrIface, SPtr<TClntCfgPD> ptrPD,
