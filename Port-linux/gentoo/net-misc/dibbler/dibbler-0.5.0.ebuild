...
# $Header: /var/cvs/dibbler/Port-linux/gentoo/net-misc/dibbler/dibbler-0.5.0.ebuild,v 1.1 2007-01-07 23:34:25 thomson Exp $
...
src_compile() {
	emake -j1 server client relay || die "Compilation failed"
}
