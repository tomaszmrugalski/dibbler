...
TOptGeneric::TOptGeneric(int optType, TMsg *parent) : TOpt(optType, parent) {
  this->Data = 0;
  this->DataLen = 0;
}
...
size_t TOptGeneric::getSize() { return DataLen + 4; }
...
std::string TOptGeneric::getPlain() { return hexToText((uint8_t *)(Data), DataLen, false); }

bool TOptGeneric::isValid() const { return true; }
