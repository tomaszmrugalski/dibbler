...
// -- Query types (RFC5007) --
typedef enum { QUERY_BY_ADDRESS = 1, QUERY_BY_CLIENTID = 2 } ELeaseQueryType;
...
enum EUnknownFQDNMode {
  UNKNOWN_FQDN_REJECT =
      0, // reject unknown FQDNs (do not assign a name from pool)
  ...
  UNKNOWN_FQDN_PROCEDURAL =
      4 // generate name procedurally, append defined domain suffix
};
