...
bool TDUID::operator==(const TDUID &other) { return (DUID_ == other.DUID_); }

bool TDUID::operator<=(const TDUID &other) { return (DUID_ <= other.DUID_); }

size_t TDUID::getLen() const { return DUID_.size(); }

const string TDUID::getPlain() const { return Plain_; }

const char *TDUID::get() const { return (const char *)(&DUID_[0]); }
