...
class TAddrMgr
{
  public:
    ...
    SPtr<TAddrIA> parseAddrIA(const char * xmlFile, FILE * f, int t1,int t2,int iaid,int iface, SPtr<TIPv6Addr> unicast = 0);
    SPtr<TAddrIA> parseAddrPD(const char * xmlFile, FILE * f, int t1,int t2,int iaid,int iface, SPtr<TIPv6Addr> unicast = 0);
