...
class TAddrMgr
{
  public:
    ...
    SPtr<TAddrIA> parseAddrIA(FILE * f, int t1,int t2,int iaid,int iface, SPtr<TIPv6Addr> unicast = 0);
    SPtr<TAddrIA> parseAddrPD(FILE * f, int t1,int t2,int iaid,int iface, SPtr<TIPv6Addr> unicast = 0);
