...
public:
  ...
  bool addClntAddr(SPtr<TDUID> clntDuid, SPtr<TIPv6Addr> clntAddr, int iface,
                   unsigned long IAID, unsigned long T1, unsigned long T2,
                   SPtr<TIPv6Addr> addr, unsigned long pref,
  ...
  bool addTAAddr(SPtr<TDUID> clntDuid, SPtr<TIPv6Addr> clntAddr, int iface,
  ...
  void addCachedEntry(SPtr<TDUID> clntDuid, SPtr<TIPv6Addr> cachedEntry,
                      TIAType type);
