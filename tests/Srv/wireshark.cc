...
TEST_F(ServerTest, parseDoubleRelay) {
 ...
 "guess-mode\n"
    ...
    sendHex("2001:888:db8:1::5", 547, "2001:db8:100:f101::3", 547, iface_->getName(),
            "");
    ...
    const char* ifaceid = "ISAM144 eth 1/1/05/02";
    TSrvOptInterfaceID expected_ifaceId(ifaceid, strlen(ifaceid), 0);
    EXPECT_EQ(*rcvRelay[0].InterfaceID_, expected_ifaceId);
